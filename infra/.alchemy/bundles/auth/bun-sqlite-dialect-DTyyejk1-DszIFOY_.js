...
e(() => {
  (o(),
    ...
    (BunSqliteDriver = class {
      ...
      async init() {
        ((this.#n = this.#e.database),
          (this.#r = new BunSqliteConnection(this.#n)),
    ...
    (BunSqliteConnection = class {
      ...
      executeQuery(e) {
        let { sql: t, parameters: n } = e,
          r = this.#e.prepare(t),
          i = n;
        if (r.columnNames.length > 0) return Promise.resolve({ rows: r.all(...i) });
    ...
    (BunSqliteQueryCompiler = class extends t {
    ...
    (BunSqliteDialect = class {
      ...
      createDriver() {
        return new BunSqliteDriver(this.#e);
      }
      createQueryCompiler() {
      ...
      createIntrospector(e) {
        return new BunSqliteIntrospector(e);
      }
    }));
})();
