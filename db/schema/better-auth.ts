 ...
 * - `account`: credential/OAuth provider links
...
export const user = sqliteTable("user", {
  ...
  image: text("image"),
  // Admin plugin fields. role is comma-separated for multiple roles and
  // rides in the JWT payload for the gateway to stamp as x-user-role.
  role: text("role"),
